          ...
          <Card className="gap-3 active:opacity-80">
            ...
            <View className="flex-row items-center gap-3">
              <View className="flex-1 gap-1">
                ...
                <Text className="text-xs text-vc-text-muted-dark">{group.patientIds.length ? `Pacientes: ${group.patientIds.map(patientInitials).join(', ')}` : 'Nenhum paciente vinculado'}</Text>
              </View>
